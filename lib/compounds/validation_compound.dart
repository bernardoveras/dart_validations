...
/// Class responsible for composing a list of field validations and checking
...
class ValidationCompound implements Validation {
  ...
  /// Method that checks that all field validations
  /// are valid for the specified field.
  ///
  /// Returns `null` if all validations are valid,
  ...
  ValidationError? validate({
    ...
    for (final validation
        in validations.where((v) => v.fieldName == fieldName)) {
